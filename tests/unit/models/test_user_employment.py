...
class TestUserEmployment(UnitTest):
    ...
    def test_getlist(self):
        ...
        response = self.moco.UserEmployment.getlist(from_date=from_date, to_date=to_date, user_id=user_id)
    ...
    def test_getlist_sort_default(self):
        ...
        response = self.moco.UserEmployment.getlist(sort_by=sort_by)
    ...
    def test_getlist_sort_overwrite(self):
        ...
        response = self.moco.UserEmployment.getlist(sort_by=sort_by, sort_order=sort_order)
    ...
    def test_getlist_page_overwrite(self):
        ...
        response = self.moco.UserEmployment.getlist(page=page_overwrite)
